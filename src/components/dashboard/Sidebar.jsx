  ...
  return (
    <aside className="w-72 min-h-screen bg-slate-900 border-r border-slate-800 flex flex-col">
        ...
        <div className="space-y-2">
          ...
          {menuItems.map((item) => (
            <Link
              key={item.title}
              href={item.href}
              className="flex items-center gap-4 px-4 py-3 rounded-xl text-slate-300 hover:bg-indigo-600 hover:text-white transition-all duration-300"
            >
      ...
      <div className="border-t border-slate-800 p-5 space-y-3">
        ...
        <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-slate-300 hover:bg-slate-800 transition">
