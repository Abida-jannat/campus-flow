        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="#" className="hover:text-indigo-400">Modules</Link></li>
          ...
          <div>
            ...
            <button className="mt-6 bg-indigo-600 hover:bg-indigo-500 px-6 py-3 rounded-xl text-white font-medium transition">
              Get Started
            </button>
          </div>
