...
export default function SettingsPage() {
  ...
  // 1. Fetch authenticated user data from database API
  useEffect(() => {
  ...
  const handleImageUpload = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        setAvatar(reader.result); // Sets base64 image data
      };
  ...
  const handleSave = async (e) => {
    ...
    // Handle Password Change Tab using Better Auth
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 pb-12">
      ...
      {savedMessage && (
        <div className="flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/40 text-emerald-400 text-xs px-4 py-3 rounded-xl transition">
      ...
      <form onSubmit={handleSave} className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-8">
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-3">
                    ...
                    <label
                      ...
                      className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-medium px-4 py-2.5 rounded-xl cursor-pointer transition shadow-lg shadow-indigo-600/20"
                    >
                    ...
                    {avatar && (
                      <button
                        ...
                        className="flex items-center gap-1.5 text-xs text-red-400 hover:text-red-300 bg-red-500/10 hover:bg-red-500/20 border border-red-500/20 px-3 py-2.5 rounded-xl transition"
                      >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-10 pr-4 py-2.5 text-xs text-white outline-none focus:border-indigo-500 transition"
                    />
                  </div>
                </div>
        ...
        {activeTab === "notifications" && (
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <label className="flex items-center justify-between p-4 rounded-xl bg-slate-950 border border-slate-800 cursor-pointer hover:border-slate-700 transition">
                <div>
        ...
        <div className="flex justify-end border-t border-slate-800 pt-4">
          <button
            type="submit"
            className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold px-6 py-2.5 rounded-xl transition cursor-pointer shadow-lg shadow-indigo-600/20"
          >
